...
TABLE_NAME = "Full_process_reporting_SL"
...
@router.get("/fullProcessInventorySL", summary="全流程报工库存-锁梁车间")
# @cache(expire=1800)
async def get_data(
...
@router.get("/fullProcessInventorySL/options", summary="锁梁下拉选项")
@cache(expire=72000)
...
@router.get("/fullProcessInventorySL/summary", summary="锁梁按当前工序ID汇总库存")
