...
TABLE_NAME = "Full_process_reporting_STC"
...
@router.get("/fullProcessInventorySTC", summary="全流程报工库存-锁体C车间")
@cache(expire=1800)
async def get_data(
...
@router.get("/fullProcessInventorySTC/options", summary="STC下拉选项")
@cache(expire=72000)
...
@router.get("/fullProcessInventorySTC/summary", summary="STC按当前工序ID汇总库存")
