...
TABLE_NAME = "Full_process_reporting_DZS"
...
@router.get("/fullProcessInventoryDZS", summary="全流程报工库存-电子锁车间")
@cache(expire=1800)
async def get_data(
...
@router.get("/fullProcessInventoryDZS/options", summary="DZS下拉选项")
@cache(expire=72000)
...
@router.get("/fullProcessInventoryDZS/summary", summary="DZS按当前工序ID汇总库存")
