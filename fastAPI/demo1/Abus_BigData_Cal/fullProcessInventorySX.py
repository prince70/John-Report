...
TABLE_NAME = "Full_process_reporting_SX"
...
@router.get("/fullProcessInventorySX", summary="全流程报工库存-锁配件车间")
# @cache(expire=1800)
async def get_data(
...
@router.get("/fullProcessInventorySX/options", summary="锁配件下拉选项")
@cache(expire=72000)
...
@router.get("/fullProcessInventorySX/summary", summary="锁配件按当前工序ID汇总库存")
