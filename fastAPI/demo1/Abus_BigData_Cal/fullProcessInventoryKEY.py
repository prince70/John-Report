...
TABLE_NAME = "Full_process_reporting_KEY"
...
@router.get("/fullProcessInventoryKEY", summary="全流程报工库存-钥匙车间")
@cache(expire=1800)
async def get_data(
...
@router.get("/fullProcessInventoryKEY/options", summary="KEY下拉选项")
@cache(expire=72000)
...
@router.get("/fullProcessInventoryKEY/summary", summary="KEY按当前工序ID汇总库存")
