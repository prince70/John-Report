...
TABLE_NAME = "Full_process_reporting_DM_ZPQ"
...
@router.get("/fullProcessInventoryDM_ZPQ", summary="全流程报工库存-打磨车间-装配区")
# @cache(expire=1800)
async def get_data(
...
@router.get("/fullProcessInventoryDM_ZPQ/options", summary="打磨装配区下拉选项")
@cache(expire=72000)
...
@router.get("/fullProcessInventoryDM_ZPQ/summary", summary="打磨装配区按当前工序ID汇总库存")
