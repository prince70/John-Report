...
TABLE_NAME = "Full_process_reporting_ZQ_GNSQ"
...
@router.get("/fullProcessInventoryZQ_GNSQ", summary="全流程报工库存-装嵌车间-功能锁区")
# @cache(expire=1800)
async def get_data(
...
@router.get("/fullProcessInventoryZQ_GNSQ/options", summary="装嵌功能锁区下拉选项")
@cache(expire=72000)
...
@router.get("/fullProcessInventoryZQ_GNSQ/summary", summary="装嵌功能锁区按当前工序ID汇总库存")
