...
TABLE_NAME = "Full_process_reporting_KL"
...
@router.get("/fullProcessInventoryKL", summary="全流程报工库存-开料车间")
@cache(expire=1800)
async def get_data(
...
@router.get("/fullProcessInventoryKL/options", summary="KL下拉选项")
@cache(expire=72000)
...
@router.get("/fullProcessInventoryKL/summary", summary="KL按当前工序ID汇总库存")
