...
TABLE_NAME = "Full_process_reporting_ZQ_LMSQ"
...
@router.get("/fullProcessInventoryZQ_LMSQ", summary="全流程报工库存-装嵌车间-铝门锁区")
# @cache(expire=1800)
async def get_data(
...
@router.get("/fullProcessInventoryZQ_LMSQ/options", summary="装嵌铝门锁区下拉选项")
@cache(expire=72000)
...
@router.get("/fullProcessInventoryZQ_LMSQ/summary", summary="装嵌铝门锁区按当前工序ID汇总库存")
