...
TABLE_NAME = "Full_process_reporting_ZQ_DZSQ"
...
@router.get("/fullProcessInventoryZQ_DZSQ", summary="全流程报工库存-装嵌车间-胆仔锁区")
# @cache(expire=1800)
async def get_data(
...
@router.get("/fullProcessInventoryZQ_DZSQ/options", summary="装嵌胆仔锁区下拉选项")
@cache(expire=72000)
...
@router.get("/fullProcessInventoryZQ_DZSQ/summary", summary="装嵌胆仔锁区按当前工序ID汇总库存")
